  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, "Server Name: %a\n", HostName));
  ...
  if (!EFI_ERROR (Status)) {
    ...
    DEBUG ((DEBUG_INFO, "Resolved IP Address: %d.%d.%d.%d\n", NvData->NvmeofSubSystemIp.v4.Addr[0], 
    NvData->NvmeofSubSystemIp.v4.Addr[1], NvData->NvmeofSubSystemIp.v4.Addr[2], NvData->NvmeofSubSystemIp.v4.Addr[3]));
    Status = EFI_SUCCESS;
  }
