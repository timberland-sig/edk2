/** @file
  NvmeOf driver BlockIo is used to manage non-volatile memory subsystem which follows
...
#ifndef _EFI_NVMEOF_BLOCKIO_H_
#define _EFI_NVMEOF_BLOCKIO_H_

#include "NvmeOfDriver.h"
#include "spdk/nvme.h"
#include "nvme_internal.h"

#define ERROR_IN_COMPLETION    2
#define IS_COMPLETED           1
#define DELAY                  100
...
**/
EFI_STATUS
EFIAPI NvmeOfBlockIoReadBlocks (
  IN  EFI_BLOCK_IO_PROTOCOL   *This,
  IN  UINT32                  MediaId,
  IN  EFI_LBA                 Lba,
  IN  UINTN                   BufferSize,
...
**/
EFI_STATUS
EFIAPI NvmeOfBlockIoReadBlocksEx (
  IN     EFI_BLOCK_IO2_PROTOCOL *This,
  IN     UINT32                 MediaId,
  IN     EFI_LBA                Lba,
