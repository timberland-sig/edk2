...
| include/spdk_internal/nvme_tcp.h | NetworkPkg/Library/DxeSpdkLib/SpdkShim/spdk/spdk_internal/nvme_tcp.h  | Compiler compatibility, Coverity fixes | [<span id="_Toc81475919" class="anchor"></span>include/spdk_internal/nvme_tcp.h](#includespdk_internalnvme_tcph) |
...
### <span id="_Toc81475912" class="anchor"></span>SPDK Imported Source

Storage for documentation of all changes made to imported SPDK source files.

---
#### <span id="_Toc81475913" class="anchor"></span>lib\/nvme\/nvme.c

``` diff
diff --git a/lib/nvme/nvme.c b/lib/nvme/nvme.c
index 5365fb03d..e1d5440df 100644
--- a/lib/nvme/nvme.c
+++ b/lib/nvme/nvme.c
@@ -9,6 +9,8 @@
...
---
#### <span id="_Toc81475914" class="anchor"></span>lib/nvme/nvme_ctrlr.c

```diff
diff --git a/lib/nvme/nvme_ctrlr.c b/lib/nvme/nvme_ctrlr.c
index a75b81cb6..ba4db89b8 100644
...
@@ -2095,8 +2097,6 @@ spdk_nvme_ctrlr_reconnect_poll_async (
...
---
#### <span id="_Toc81475915" class="anchor"></span>lib/nvme/nvme_fabric.c

```diff
diff --git a/lib/nvme/nvme_fabric.c b/lib/nvme/nvme_fabric.c
index c5d6e218d..76321f7a5 100644
...
---
#### <span id="_Toc81475916" class="anchor"></span>lib/nvme/nvme_qpair.c
```diff
diff --git a/lib/nvme/nvme_qpair.c b/lib/nvme/nvme_qpair.c
index 452e70e27..5a1b48905 100644
...
---
#### <span id="_Toc81475917" class="anchor"></span>lib/nvme/nvme_tcp.c

```diff
diff --git a/lib/nvme/nvme_tcp.c b/lib/nvme/nvme_tcp.c
index 7719624a9..a0f1f3d77 100644
...
@@ -42,6 +34,16 @@ struct nvme_tcp_ctrlr {
   struct spdk_nvme_ctrlr    ctrlr;
 };
...
@@ -149,21 +151,11 @@ struct nvme_tcp_req {
...
---
#### <span id="_Toc81475918" class="anchor"></span>lib/nvme/nvme_transport.c
```diff
diff --git a/lib/nvme/nvme_transport.c b/lib/nvme/nvme_transport.c
index 96dfe3ea7..7a34152d2 100644
...
---
#### <span id="_Toc81475919" class="anchor"></span>include/spdk_internal/nvme_tcp.h
```diff
diff --git a/include/spdk_internal/nvme_tcp.h b/include/spdk_internal/nvme_tcp.h
index 7214c2b20..0e930f130 100644
...
---
#### <span id="_Toc81475920" class="anchor"></span>include/spdk_internal/sock.h
```diff
diff --git a/include/spdk_internal/sock.h b/include/spdk_internal/sock.h
index 81298378b..2bffde904 100644
