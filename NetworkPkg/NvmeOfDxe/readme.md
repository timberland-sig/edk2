...
| NvmeofHostId                   | Host NID                 | Blank                                                                        | UUID format.                                                                                                                                                                                                                                                                                                   |
...
The main NVMe-oF configuration form contains fields for Host NQN, Host NID, and a dynamically created list of available attempts from “Attempt 1” to the maximum value defined by PcdMaxNvmeOfAttemptNumber.
